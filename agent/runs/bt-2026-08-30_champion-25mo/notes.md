# Run notes — VARIANT C full-window: Weekly Champion Wheel (2,5 tahun)

RUN LANJUTAN (30 Agu): varian C yang sama, window diperluas ke 2024-03-01 ->
2026-07-07/31 agar sebanding langsung dengan baseline 2,5 tahun. Run 1-tahun
asli (artefak tidak tersentuh) ada di bt-2026-08-29_weekly-champion/.
Kejujuran window: paruh 2024-03->2025-07 bersifat in-sample-by-design (desain
varian dibentuk setelah melihat diagnostik baseline di periode itu); slice
2025-08->2026-07 adalah OOS yang pre-committed (hasilnya +46,4% vs SPY +20,1%).
